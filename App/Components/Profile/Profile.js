...
class Profile extends Component {
    ...
    handleDelete() {
      Alert.alert(
          ...
          [
            ...
            {text: 'Delete', onPress: () => this.props.userActions.deleteAccount(this.props.user.id)}
          ],
          { cancelable: false }
      )
    }
    ...
    deleteError() {
      this.props.deleteAccError ? 
          Alert.alert(
              ...
              [
                  {text: 'OK', onPress: () => this.props.dispatch({type: 'DELETE_ACC_ERROR' , payload: false })}
              ],
              { cancelable: false }
          )
      : false ;
    ...
    onSwitchChange = (value) => {
      ...
      this.props.userActions.updateUser(values, navigate);
    }
